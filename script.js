...
// ============ MODAL ===========
const plantButton = document.querySelector('.main__button');
...
// MODAL
plantButton.addEventListener('click', () => modal.classList.toggle('show-modal'));
modalButton.addEventListener('click', () => modal.classList.toggle('show-modal'));